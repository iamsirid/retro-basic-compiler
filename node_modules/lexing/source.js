...
*/
function indexOf(source, searchValue, fromIndex, BLOCK_SIZE) {
...
*/
function lastIndexOf(source, searchValue, fromIndex, BLOCK_SIZE) {
    if (fromIndex === void 0) { fromIndex = source.size; }
    if (BLOCK_SIZE === void 0) { BLOCK_SIZE = 1024; }
    var needle = new Buffer(searchValue);
    var position = fromIndex;
    var haystack = new Buffer(0);
