...
*/
var BufferedSourceReader = /** @class */ (function () {
...
var SourceBufferIterator = /** @class */ (function (_super) {
    ...
    function SourceBufferIterator(source, position, block_size) {
        ...
        var _this = _super.call(this, source, position, block_size) || this;
        _this.next = _this._nextBytes;
        _this.peek = _this._peekBytes;
        _this.skip = _this._skipBytes;
        return _this;
    }
    return SourceBufferIterator;
}(BufferedSourceReader));
exports.SourceBufferIterator = SourceBufferIterator;
var SourceStringIterator = /** @class */ (function (_super) {
    __extends(SourceStringIterator, _super);
    function SourceStringIterator(source, _encoding, position, block_size) {
        if (position === void 0) { position = 0; }
        if (block_size === void 0) { block_size = 1024; }
        var _this = _super.call(this, source, position, block_size) || this;
        _this._encoding = _encoding;
        // Provide raw Buffer-level access, too, beyond/outside the StringIterable interface.
        _this.nextBytes = _this._nextBytes;
        _this.peekBytes = _this._peekBytes;
        _this.skipBytes = _this._skipBytes;
        return _this;
    }
...
var TokenizerIterator = /** @class */ (function () {
...
var CombinerIterator = /** @class */ (function () {
